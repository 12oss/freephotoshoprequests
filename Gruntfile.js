	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/freephotoshoprequests.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/freephotoshoprequests.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/freephotoshoprequests.css',
				dest: '_gh_pages/dist/css/min/freephotoshoprequests.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/freephotoshoprequests.js',
				dest: '_gh_pages/dist/js/min/freephotoshoprequests.min.js'
			}
		},
		watch: {
			css: {
